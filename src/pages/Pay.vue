<template>
  <div class='home-act'>
    ...
    <div class="act-main">
      ...
      <group :gutter='10'>
        <cell  >
          <p slot='title'><span style="color:#000;font-size: 16px;">{{fac}}</span> <span style="display:block;font-size: 14px;">产品报名费</span></p>
          ...
          .catch(err =>{
              if(err.response.status===401){
                ...
                setTimeout(() => {
                  ...
                  that.$router.push({name:'login',query:{redirect:'/school/Pay/'+that.$route.params.id+'/'+that.$route.params.tip+'/'+that.$route.params.money}});
                }, 1000)
              }
          })
