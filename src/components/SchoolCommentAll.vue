  ...
  <div>
    <v-scroll style="height: 100%;background: #fff;" :on-refresh="onRefresh" :on-infinite="onInfinite">
      <ul class="sch-det-con clearfix">
        <li v-for='(items,a) in list' :key="a" v-if="items.count>0">
          {{items.name}}{{items.count}}
        </li>
      </ul>
      <router-link  v-for="(temp,index11) in listdata" :key="'a'+index11" :to="'/school/schoolComDetail/'+temp.id" class="comment">
        <div style="display:flex;">
          ...
          <div class="com-box">
            ...
            <div>
              ...
              <div class="pic-box">
                <flexbox :gutter='12.5' style="width: 33%;float: left;margin-bottom:3px;"   v-for='(item ,b) in temp.urls' :key="b">
        ...
        <div style="display:flex;">
          ...
          <div class="com-box">
            ...
            <div>
              ...
              <div class="pic-box">
                <flexbox :gutter='12.5' style="width: 33%;float: left;margin-bottom:3px;"   v-for='(item,c) in child.urls' :key="c">
                  <flexbox-item   class='find-main-f'>
                    <div class="com-pic">
                      <img :src="item" alt="">
                    </div>
  ...
  export default {
    ...
    created(){
      ...
      this.$axios.get('/api/v2/schoolTags',{
          params:{sId: this.$route.params.id}
      }).then(res=>{
