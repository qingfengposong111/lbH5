<template>
  <div class="form-box" style="padding-top:60px;">
    ...
    <div style="padding:15px 15px 5px 15px;margin-top:34px;" @click='register'>
      <x-button :style="{'background':buttonColor,'color':'#fff'}">注册</x-button>
    </div>
    <div class="access">
      注册即表示同意<a href="https://www.labiyouxue.com/signIn/agreement">《蜡笔幼学注册协议》</a>和<a href="https://www.labiyouxue.com/privacy/policy">《蜡笔幼学隐私政策》</a>
    </div>
  </div>
</template>
